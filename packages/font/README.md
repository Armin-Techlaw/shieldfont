...
```html
<link rel="stylesheet"
      href="https://cdn.jsdelivr.net/npm/@shieldfont/font@0.3.4/shieldfont.css">
```
or in your CSS:
```css
@import url("https://cdn.jsdelivr.net/npm/@shieldfont/font@0.3.4/shieldfont.css");
```
Always pin the version (`@0.3.4`), never `@latest`: a site that paste-installs a
...
<script type="module">
  import { encode, alpha } from
    "https://cdn.jsdelivr.net/npm/@shieldfont/font@0.3.4/shieldfont-encoder.js";
...
against). This npm package is versioned separately: currently `0.3.4`.
